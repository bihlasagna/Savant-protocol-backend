...
import './interfaces/ISPETHERC20SplitsPayerDeployer.sol';
...
/** 
  ...
  @dev
  Adheres to -
  ISPETHERC20SplitsPayerDeployer:  General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
contract SPETHERC20SplitsPayerDeployer is ISPETHERC20SplitsPayerDeployer {
  //*********************************************************************//
  ...
  */
  function deploySplitsPayer(
    ...
    address _owner
  ) external override returns (ISPSplitsPayer splitsPayer) {
    // Deploy the splits payer.
    splitsPayer = new SPETHERC20SplitsPayer(
