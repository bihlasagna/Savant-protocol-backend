...
library SPGlobalFundingCycleMetadataResolver {
  ...
  */
  function packFundingCycleGlobalMetadata(SPGlobalFundingCycleMetadata memory _metadata)
    internal
    pure
