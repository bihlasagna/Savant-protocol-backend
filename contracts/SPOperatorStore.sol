...
/** 
  ...
  @dev
  Adheres to -
  ISPOperatorStore: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
contract SPOperatorStore is ISPOperatorStore {
  //*********************************************************************//
  // --------------------------- custom errors ------------------------- //
  //*********************************************************************//
  ...
  */
  function setOperator(SPOperatorData calldata _operatorData) external override {
  ...
  */
  function setOperators(SPOperatorData[] calldata _operatorData) external override {
