...
import './interfaces/ISPPriceFeed.sol';
...
/** 
  ...
  @dev
  Adheres to -
  ISPPriceFeed: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
contract SPChainlinkV3PriceFeed is ISPPriceFeed {
  // A library that provides utility for fixed point numbers.
  using SPFixedPointNumber for uint256;
