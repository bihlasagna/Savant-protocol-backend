...
/// @notice This file tests SPToken related flows
contract TestTokenFlow is TestBaseWorkflow {
  ...
  function testFuzzTokenFlow(
    ...
    // create a new ISPToken and change it's owner to the tokenStore
    ISPToken _newToken = new SPToken('NewTestName', 'NewTestSymbol');
    ...
    // confirm the project's new SPToken
