...
import './libraries/SPGlobalFundingCycleMetadataResolver.sol';
...
*/
contract SPDirectory is ISPDirectory, SPOperatable, Ownable {
  // A library that parses the packed funding cycle metadata into a friendlier format.
  using SPGlobalFundingCycleMetadataResolver for uint8;
  ...
  */
  function setPrimaryTerminalOf(
    ...
    external
    override
    requirePermission(projects.ownerOf(_projectId), _projectId, SPOperations.SET_PRIMARY_TERMINAL)
  {
