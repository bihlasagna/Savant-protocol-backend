...
import './../interfaces/ISPSingleTokenPaymentTerminal.sol';
...
/**
  ...
  @dev
  Adheres to -
  ISPSingleTokenPaymentTerminals: General interface for the methods in this contract that interact with the blockchain's state according to the protocol's rules.
*/
abstract contract SPSingleTokenPaymentTerminal is ISPSingleTokenPaymentTerminal, ERC165 {
  //*********************************************************************//
  ...
  */
  ...
  {
    return
      _interfaceId == type(ISPPaymentTerminal).interfaceId ||
      _interfaceId == type(ISPSingleTokenPaymentTerminal).interfaceId ||
